...
function useQueryWithPagination(QUERY_DEFINITION, variables, config) {
  ...
  var _usePagination = usePagination(config),
      rowsPerPage = _usePagination.rowsPerPage,
      rowsPerPageOptions = _usePagination.rowsPerPageOptions,
      page = _usePagination.page,
      onChangePage = _usePagination.onChangePage,
      onChangeRowsPerPage = _usePagination.onChangeRowsPerPage;
...
var GROUPS = client.gql(_templateObject());
...
var USERS = client.gql(_templateObject$1());
